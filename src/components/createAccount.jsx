...
class CreateAccount extends React.Component {
    ...
    state = {
      ...
      validateAll=()=>{
        ...
        if(!mobileNo) errors.mobileNo="Number Must Be mobile number";
      ...
      validateName=(name)=>
        ...
        !mobileNo ? "Number must be entered" :mobileNo.length=10 ? "Number Is Not Valid" : "";

        validateName=(password)=>
        !password ? "Password must be entered" : password.length<4 ? " Min 4 Character Required" : "";
